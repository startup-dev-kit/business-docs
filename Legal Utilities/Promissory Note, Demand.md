...
We recommend a Balloon Note instead of this one because there is a
predictable end point for all parties. Whether you use a Balloon Note or
this Demand note, either kind should be used, in our opinion, if a
friend or family member requests a loan. The best result can be for the
